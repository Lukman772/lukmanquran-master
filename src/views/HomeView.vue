<template>
  ...
  <div class="text-sm-center mt-5">
    <h1 class="text-lg-center">Silahkan Masukkan Nomor Surah</h1>
    <input v-model="cari" class="form-control sm-5 text-lg-center" type="search" placeholder="1-114..." aria-label="Search">
    <div v-if="cari">
      <div class="mt-5">
